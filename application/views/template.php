	...
	<a href="<?php echo base_url().'c_auth/logout'?>">Logout</a>
		...
		<section class="current-body">
			...
			<section class="menu-container">
		        ...
		        <section class="top">
			<h2>General</h2>
			<div title="click to expand" class="max general">
				+
			</div>
			<div title="click to minimize" class="min general" style="display:none">
				-
			</div>
		</section>
		<ul>
			<li>
				<a id = "internalFort_A1_li" class="general-url">Sample Form</a>
			</li>
		</ul>

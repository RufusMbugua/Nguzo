...
$(document).ready(function() {
	...
	function saltMin() {
		...
		function generalMax() {
		$(".max.general").hide('fast');
		$(".min.general").show('fast');
	...
	function generalMin() {
		$(".min.general").hide('fast');
		$(".max.general").delay(450).show('fast');
		$(".menu.general").animate({
			height : '25px'
		},100);
		$(".menu.salt").show('fast');
	...
	$(".max.general").click(function() {
		generalMax();
		

	});

	$(".min.general").click(function() {
		generalMin();
	});
